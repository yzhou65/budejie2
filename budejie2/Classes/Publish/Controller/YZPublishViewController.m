...
@interface YZPublishViewController ()
@end

@implementation YZPublishViewController
...
- (void)viewDidLoad {
    ...
    for (int i = 0; i<images.count; i++) {
        YZVerticalButton *button = [[YZVerticalButton alloc] init];
        button.tag = i;
...
- (void)buttonClick:(UIButton *)button
{
    [self cancelWithCompletionBlock:^{
        if (button.tag == 2) {
            YZPostWordViewController *postWord = [[YZPostWordViewController alloc] init];
            YZNavigationController *nav = [[YZNavigationController alloc] initWithRootViewController:postWord];
